...
#define STRING_CONFIG_H_AUTHOR "(BIGTREETECH, SKR PRO-V1.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Metalka"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  9.72,  9.48 }
    #define DEFAULT_Ki_LIST {  0.46,  0.42 }
    #define DEFAULT_Kd_LIST { 50.94, 53.27 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2500, 2500, 200, 4000 }
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 16.5
  #define DEFAULT_YJERK 16.5
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 12, 20, -1.35 }
...
#define PREHEAT_5_LABEL       "ASA 275"
